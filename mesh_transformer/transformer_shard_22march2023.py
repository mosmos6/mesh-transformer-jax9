...
from mesh_transformer.layers import EmbeddingShard, TransformerLayerShard, RelativePositionEmbs, ProjectionShard, TransformerLayerShardV2, Projection, EmbeddingShardV2
...
class CausalTransformer:
    def __init__(self, config):
        ...
        def init(key, x):
            ...
            print('5')
            return {"opt_state": optimizer.init(params)}
            print('6')
            return {"params": ("early_cast" in config and to_bf16 or to_f32)(params)}
            print('7')
        print('16')
        ...
        x = jax.random.uniform(next(key), example_shape, minval=0, maxval=vocab)  # batch, len
